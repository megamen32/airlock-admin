...
describe('Air CLI commands', () => {
  it('installs the versioned global launcher', () => {
    expect(airlockInstallCommand('github.com/airlockrun/agentsdk/cmd/airlock', '0.4.0-rc.37')).toBe(
      'go install github.com/airlockrun/agentsdk/cmd/airlock@v0.4.0-rc.37',
    )
  })
