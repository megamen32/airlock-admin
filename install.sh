...
#
#   curl -fsSL https://raw.githubusercontent.com/airlockrun/airlock/v0.4.0-rc.22/install.sh | bash
#
# Or inspect first (recommended):
#   curl -fsSL https://raw.githubusercontent.com/airlockrun/airlock/v0.4.0-rc.22/install.sh -o install.sh
...
RELEASE_TAG="${AIRLOCK_TAG:-v0.4.0-rc.22}"
