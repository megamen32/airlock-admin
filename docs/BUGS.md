...
- Evidence: immutable Codex connector responses on 2026-07-27: `gptadmin_discover` and `gptadmin_ui` both failed with `UNAUTHORIZED`, `reauthentication_required`, and `oauth_refresh_token_missing`; no tool or interactive Allow surface could be reached. Reconnect then showed the generic setup failure in [`codex-clipboard-da2693b9-38a3-420e-8403-8011b55d2c91.png`](/home/roomhacker/.codex/attachments/06e3bc16-fa76-495e-b82d-8912ed95c7f4/codex-clipboard-da2693b9-38a3-420e-8403-8011b55d2c91.png).
...
- First observed: immutable evidence [`trash/logs/production-browser-502-20260725.md`](../trash/logs/production-browser-502-20260725.md), from a real headless Chromium probe at `2026-07-25T15:05:38+03:00`.
