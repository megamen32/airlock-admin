...
Авторитетный исходник: `/home/roomhacker/agents-projects/grepmesh`. Карта кода
...
│   ▸ projects  │ ───────────────────────────────────────────────── │ host/scope   │
│   ▸ home      │ server-44 / projects / billing/invoice_2025.csv    │ линии 42–68  │
│ ◐ server-44   │  Live · текст · 18 KB · 4 совпадения               │              │
