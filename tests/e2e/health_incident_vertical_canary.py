...
NOTICEPLACE_ROOT = Path("/home/roomhacker/agents-projects/noticeplace")
HEALTH_ROOT = Path("/home/roomhacker/ServersAdministartion/automation/health-incident-monitor")
