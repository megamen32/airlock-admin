...
The Rust package builds `/home/roomhacker/gptadmin/grepmesh/target/release/grepmesh`, while `grepmesh/grepmesh-mcp.service:8` starts `/usr/local/bin/grepmesh-mcp`.
