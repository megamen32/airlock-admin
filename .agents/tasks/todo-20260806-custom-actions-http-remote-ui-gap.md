...
- Symptom: live `gptadmin.bezrabotnyi.com` redirects to `became.bezrabotnyi.com`, where Custom GPT Action/OpenAPI and MCP routes return 404; public MCP page only shows generic placeholder URLs and no selected-MCP Bearer HTTP Remote config.
