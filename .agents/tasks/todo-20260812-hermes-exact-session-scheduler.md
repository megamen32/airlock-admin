...
- Lifecycle provenance: Created by Lead from the user-attached architecture request at `/home/roomhacker/.codex/attachments/4648c193-621d-43b4-bebb-fa0e2db02739/pasted-text.txt`; this is the immutable todo snapshot.
...
- Harness: Codex desktop, shared primary checkout `/home/roomhacker/gptadmin`.
...
Allowed read-only paths: `/home/roomhacker/gptadmin/.last-human-commit/adapters/hermes/`, `/home/roomhacker/gptadmin/.last-human-commit/`, documented installed Hermes configuration/plugin paths, and relevant tests/docs. Excluded: all mutations, all runtime control, all network effects, unrelated repository paths.
