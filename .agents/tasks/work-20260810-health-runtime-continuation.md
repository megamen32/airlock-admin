...
- The installed `health-incident-fleet.timer` is enabled and active with
  ...
  (`roomhacker-server-100`, `roomhacker-server-88`, `server-44`, `router`,
  `haos`, `vpn2`, `vusa`) and fifteen configured log rules; all targets carry
...
- Rendered text is `IMPORTANT · health-monitor`, `vusa: CPU is above
