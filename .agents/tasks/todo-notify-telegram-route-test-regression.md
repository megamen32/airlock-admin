...
- Symptom: full pytest run for the NoticePlace workspace reported 146 passed and 1 failed in `/home/roomhacker/agents-projects/notify/tests/test_telegram_controls.py::TelegramControlPolicyTests::test_severity_route_overrides_default_chat_and_optionally_sets_topic`.
