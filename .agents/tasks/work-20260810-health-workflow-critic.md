...
- The cause is in
  `/home/roomhacker/agents-projects/noticeplace/notification_center/core.py:1539-1545`:
  ...
  `/home/roomhacker/agents-projects/noticeplace/notification_center/core.py:1575-1597`,
...
- The focused HTTP test covers the empty-fingerprint case only
  (`/home/roomhacker/agents-projects/noticeplace/tests/test_http_api.py:149-161`);
...
- The local vertical canary explicitly uses deterministic fakes for GPTAdmin,
  ...
  (`/home/roomhacker/gptadmin/tests/e2e/health_incident_vertical_canary.py:1-7,35-72,132-194`).
...
- The current core rejects a heartbeat-labelled receipt with no evidence even when it carries a fingerprint at `/home/roomhacker/agents-projects/noticeplace/notification_center/core.py:1539-1546`; the wrapper applies the same boundary at `notification_center/health_workflow.py:337-354` and returns the core's authoritative useful value.
- The HTTP regression now exercises `step=heartbeat`, empty evidence, `heartbeat_at=123`, and `progress_fingerprint=heartbeat-only`, expecting HTTP 400 and zero durable progress rows (`/home/roomhacker/agents-projects/noticeplace/tests/test_http_api.py:149-175`). The workflow regression likewise asserts rejection and no persisted progress (`tests/test_health_workflow.py:253-273`).
