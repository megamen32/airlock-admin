...
- Linux already has canonical BrowserOS running as `roomhacker`; MCP `http://127.0.0.1:9000/mcp` returned 200, initialized with protocol `2025-03-26`, and exposed 23 tools including `tabs`, `snapshot`, `act`, `read`, `grep`, and `wait`.
