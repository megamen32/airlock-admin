...
- Mac ShellMCP was switched to central Hub `https://u-f1102930.t.gptadmin.bezrabotnyi.com`; public health from Mac returned 200. Queue polling then completed a previously queued `mcp_manage list` job.
...
- Deployed cross-compiled Go ShellMCP Mach-O binary to Mac mini with backup `/Users/roomhacker/.local/share/gptadmin/bin/shellmcp.bak.20260807-path-fix` and restarted the launchd Go agent.
