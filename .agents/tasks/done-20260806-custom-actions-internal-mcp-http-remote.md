...
- Canonical host check: `gptadmin.bezrabotnyi.com` redirects to `became.bezrabotnyi.com`; after redirect `/actions/openapi.yaml`, `/connect.json`, `/mcp`, `/mcp-relay/servers`, `/server/hub/mcp`, and `/server/hub/actions/openapi.yaml` return 404.
