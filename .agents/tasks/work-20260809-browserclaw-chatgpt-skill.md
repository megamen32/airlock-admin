...
- skill размещается в `/home/roomhacker/.codex/skills/browserclaw-chatgpt-acceptance`;
- Mac mini: `192.168.2.4`, SSH alias `whitetransport-mac-mini-2012`;
...
- Skill created at `/home/roomhacker/.codex/skills/browserclaw-chatgpt-acceptance`.
