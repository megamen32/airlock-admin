...
Target is the actual `/home/roomhacker/gptadmin/grepmesh` command entrypoint in
...
- Confirmed the local repo contains `/home/roomhacker/gptadmin/grepmesh/`, but did not inspect source or docs.
