...
- Allowed paths: this repository's GrepMesh files and bounded local source/deployment evidence under `/home/roomhacker/agents-projects`, `/home/roomhacker/PycharmProjects`, `/opt`, and `/tmp`; no secrets or credentials.
