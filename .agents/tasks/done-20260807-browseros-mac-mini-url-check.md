...
- Correct candidate URL for direct Mac mini access is `http://192.168.2.4:9000/mcp` (or `http://mac-mini-2012.lan:9000/mcp`), but it is currently not healthy/connected.
