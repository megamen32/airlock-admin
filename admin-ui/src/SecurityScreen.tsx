...
export default function SecurityScreen() {
  ...
  return <div className="page-shell native-operation-page">
    <header className="page-header compact-page-header"><div><p className="section-kicker">SECURITY</p><h1>Безопасность</h1><p className="lede">Расширенные параметры защиты. Обычные настройки доступа находятся в разделе «Доступ».</p></div><div className="overview-header-actions"><button className="button secondary" type="button" disabled={busy} onClick={() => void load()}>Обновить</button></div></header>
