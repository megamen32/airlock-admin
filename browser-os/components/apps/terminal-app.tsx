...
export function TerminalApp() {
  ...
  useEffect(() => { void listComputers().then(result => setComputers((result.data ?? []).filter(item => item.capabilities.includes('files') && item.capabilities.includes('terminal')))); }, []);
