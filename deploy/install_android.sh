...
#   SHELLMCP_PORT, SHELLMCP_AUTO_START, SHELLMCP_FOREGROUND, SHELLMCP_QUEUE_TIMEOUT_S, SHELLMCP_HUB_DNS_SERVER, SHELLMCP_HUB_RESOLVE_TO
...
SHELLMCP_HUB_DNS_SERVER=${SHELLMCP_HUB_DNS_SERVER:-1.1.1.1:53}
SHELLMCP_HUB_RESOLVE_TO=${SHELLMCP_HUB_RESOLVE_TO:-}
...
HUB_URL=$HUB_URL
SHELLMCP_HUB_DNS_SERVER=$SHELLMCP_HUB_DNS_SERVER
SHELLMCP_HUB_RESOLVE_TO=$SHELLMCP_HUB_RESOLVE_TO
